...
public class Robot extends TimedRobot {
  ...
  public void autonomousInit() {
    ...
    if (m_autoSelected == taxi) { // TAXI WORKS FINE.
      ...
      drivetrain.resetEncoders();
      MoveArm.executeAngle(coralMech, L2, startOfAuto);
      DriveDistP.execute(drivetrain, coralMech, L2, kGrav, kP, 345, false, 0.1, startOfAuto, 3000, 0.015); 
      RunCoralIntake.execute(coralMech, L2, 0.5, 500, startOfAuto);
      drivetrain.resetGyro();
      drivetrain.resetEncoders();
      TurnToAnglePID.execute(drivetrain, coralMech, L2, kGrav, kP, 60, 0, System.currentTimeMillis(), 2000, 0.015, 0.3);
      drivetrain.resetGyro(); 
      drivetrain.resetEncoders();
      DriveDistP.execute(drivetrain, coralMech, HP, kGrav, kP, 250, false, 0.1, startOfAuto, 3000, 0.015); 
      drivetrain.resetEncoders();
      drivetrain.resetGyro();
      TurnToAnglePID.execute(drivetrain, coralMech, HP, kGrav, kP, 23, 0, System.currentTimeMillis(), 3000, 0.015, 0.3);
      drivetrain.resetEncoders();
      drivetrain.resetGyro(); 
      DriveDistP.execute(drivetrain, coralMech, HP, kGrav, kP, 155, false, 0.1, startOfAuto, 3000, 0.015); 
      RunCoralIntake.execute(coralMech, HP, -1, 500, startOfAuto);
      drivetrain.resetEncoders();
      drivetrain.resetGyro();
      TurnToAnglePID.execute(drivetrain, coralMech, Inside, kGrav, kP, 90, 0.0, startOfAuto, 3000, 0.015, 0.3);
      drivetrain.resetEncoders();
      drivetrain.resetGyro();
      DriveDistP.execute(drivetrain, coralMech, HP, kGrav, kP, 100, true, 0.1, startOfAuto, 3000, 0.015); 
